<div align="center">
  <img src="./images/toprouter.png?1" alt="TopRouter Dashboard" width="800"/>
  ...
  **Connect All AI Code Tools (Claude Code, Cursor, Antigravity, Copilot, Codex, Gemini, OpenCode, Cline, OpenClaw...) to 40+ AI Providers & 100+ Models.**
  ...
  [🚀 Quick Start](#-quick-start) • [💡 Features](#-key-features) • [📖 Setup](#-setup-guide) • [🌐 Website](https://toprouter.com)
...
This repository package is private (`toprouter-app`), so source/Docker execution is the expected local development path.
...
<table>
  <tr>
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=raEyZPg5xE0">
        <img src="https://img.youtube.com/vi/raEyZPg5xE0/maxresdefault.jpg" alt="TopRouter Setup Tutorial" width="300"/>
      </a><br/>
      <b>🇺🇸 English</b><br/>
      <sub>TopRouter + Claude Code FREE Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=X69n5Lm06Yw">
        <img src="https://img.youtube.com/vi/X69n5Lm06Yw/maxresdefault.jpg" alt="Tiết kiệm chi phí LLM với TopRouter" width="300"/>
      </a><br/>
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Tiết kiệm chi phí LLM cho OpenClaw với TopRouter<br/>by <a href="https://www.youtube.com/c/M%C3%ACAIblog">Mì AI</a></sub>
    </td>
    <td align="center" width="320">
  ...
  <tr>
    <td align="center" width="320">
      ...
      <b>🇺🇸 English</b><br/>
      <sub>Claude CLI Free Setup with TopRouter 🚀<br/>by <a href="https://www.youtube.com/@CodeVerseSoban">CodeVerse Soban</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Cài Đặt OpenClaw Free Từ A-Z + TopRouter<br/>by <a href="https://www.youtube.com/@maigia">Mai Gia</a></sub>
    </td>
    <td align="center" width="320">
...
> 🎬 **Made a video about TopRouter?** Submit a [Pull Request](https://github.com/decolua/toprouter/pulls) adding your video to this section — we'll merge it!

---

## 🛠️ Supported CLI Tools

TopRouter works seamlessly with all major AI coding tools:
...
- Your CLI tool sends OpenAI format → TopRouter translates → Provider receives native format
...
> TopRouter itself **never charges** you anything. You only pay providers directly (if using paid services).
> 
...
### 📊 Understanding TopRouter Costs & Billing

**TopRouter Billing Reality:**

✅ **TopRouter software = FREE forever** (open source, never charges)  
✅ **Dashboard "costs" = Display/tracking only** (not actual bills)  
✅ **You pay providers directly** (subscriptions or API fees)  
✅ **FREE providers stay FREE** (iFlow, Kiro, Qwen = $0 unlimited)  
❌ **TopRouter never sends invoices** or charges your card
...
- **Cheap providers** (GLM, MiniMax): Pay them directly, TopRouter just routes
- **FREE providers** (iFlow, Kiro, Qwen): Genuinely free forever, no hidden charges
- **TopRouter**: Never charges anything, ever
...
The dashboard tracks your token usage and displays **estimated costs** as if you were using paid APIs directly. This is **not actual billing** - it's a reference to show how much you're saving by using free models or existing subscriptions through TopRouter.
...
<details>
<summary><b>💳 Will I be charged by TopRouter?</b></summary>

**No.** TopRouter is free, open-source software that runs on your own computer. It never charges you anything.

**You only pay:**
- ✅ **Subscription providers** (Claude Code $20/mo, Codex $20-200/mo) → Pay them directly on their websites
- ✅ **Cheap providers** (GLM, MiniMax) → Pay them directly, TopRouter just routes your requests
- ❌ **TopRouter itself** → **Never charges anything, ever**

TopRouter is a local proxy/router. It doesn't have your credit card, can't send invoices, and has no billing system. It's completely free software.
...
TopRouter just routes your requests to them - there's no "catch" or future billing. They're truly free services, and TopRouter makes them easy to use with fallback support.
...
3. **Use subscription providers last:**
   ...
   - TopRouter helps maximize their value through quota tracking
...
TopRouter's smart fallback prevents surprise charges:
...
**You're in control:** Set spending limits per provider in dashboard, and TopRouter respects them.
...
**Pro Tip:** Use Opus for complex tasks, Sonnet for speed. TopRouter tracks quota per model!
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [from toprouter dashboard]
...
```json
{
  "agents": {
    "defaults": {
      "model": {
        "primary": "toprouter/kr/claude-sonnet-4.5"
      }
    }
  },
  "models": {
...
> **Note:** OpenClaw only works with local TopRouter. Use `127.0.0.1` instead of `localhost` to avoid IPv6 resolution issues.
...
# Or use PM2
npm install -g pm2
pm2 start npm --name toprouter -- start
pm2 save
pm2 startup
```
...
- Docker Hub: [`decolua/toprouter`](https://hub.docker.com/r/decolua/toprouter)
- GHCR: [`ghcr.io/decolua/toprouter`](https://github.com/decolua/toprouter/pkgs/container/toprouter)
...
docker run -d --name toprouter -p 20128:20128 \
  -v "$HOME/.toprouter:/app/data" -e DATA_DIR=/app/data toprouter
```
...
docker restart toprouter
docker stop toprouter && docker rm toprouter
docker pull decolua/toprouter:latest   # update to latest
```

**Data persistence:** `$HOME/.toprouter/db/data.sqlite` on host ↔ `/app/data/db/data.sqlite` in container.

### Environment Variables

| Variable | Default | Description |
|----------|---------|-------------|
| `JWT_SECRET` | Auto-generated (`~/.toprouter/jwt-secret`) | JWT signing secret for dashboard auth cookie (override to share across instances) |
| `INITIAL_PASSWORD` | `123456` | First login password when no saved hash exists |
| `DATA_DIR` | `~/.toprouter` | Main app data location (SQLite at `$DATA_DIR/db/data.sqlite`) |
| `PORT` | framework default | Service port (`20128` in examples) |
| `HOSTNAME` | framework default | Bind host (Docker defaults to `0.0.0.0`) |
| `NODE_ENV` | runtime default | Set `production` for deploy |
| `BASE_URL` | `http://localhost:20128` | Server-side internal base URL used by cloud sync jobs |
| `CLOUD_URL` | `https://toprouter.com` | Server-side cloud sync endpoint base URL |
| `NEXT_PUBLIC_BASE_URL` | `http://localhost:3000` | Backward-compatible/public base URL (prefer `BASE_URL` for server runtime) |
| `NEXT_PUBLIC_CLOUD_URL` | `https://toprouter.com` | Backward-compatible/public cloud URL (prefer `CLOUD_URL` for server runtime) |
...
- Both `${DATA_DIR}` and `~/.toprouter` resolve to the same location in a Docker container — the symlink `/root/.toprouter -> /app/data` is created at build time.
...
Thanks to all contributors who helped make TopRouter better!

[![Contributors](https://contrib.rocks/image?repo=decolua/toprouter&max=150&columns=15&anon=1&v=20260309)](https://github.com/decolua/toprouter/graphs/contributors)

---

## 📊 Star Chart

[![Star Chart](https://starchart.cc/decolua/toprouter.svg?variant=adaptive)](https://starchart.cc/decolua/toprouter)



## 🔀 Forks

**[OmniRoute](https://github.com/diegosouzapw/OmniRoute)** — A full-featured TypeScript fork of TopRouter. Adds 36+ providers, 4-tier auto-fallback, multi-modal APIs (images, embeddings, audio, TTS), circuit breaker, semantic cache, LLM evaluations, and a polished dashboard. 368+ unit tests. Available via npm and Docker.
...
- **[RTK](https://github.com/rtk-ai/rtk)** ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk?style=flat&color=yellow) — Rust token-saver. TopRouter ports its compression pipeline to JS → **−20-40% input tokens** on every request.
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) by **[@JuliusBrussee](https://github.com/JuliusBrussee)** — viral *"why use many token when few token do trick"*. TopRouter adapts its prompt → **−65% output tokens**.

Huge thanks to these authors — without their work, TopRouter's token-saving features wouldn't exist. ⭐ them on GitHub!
