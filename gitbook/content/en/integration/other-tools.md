...
TopRouter is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

TopRouter provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to TopRouter using these settings:

**Local TopRouter:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any TopRouter model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to TopRouter
```bash
...
- Check network connection to TopRouter
