...
Integrate TopRouter with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- TopRouter API key from [dashboard](https://toprouter.com/dashboard)
- TopRouter running (local or cloud)
...
### 2. Add TopRouter Model Configuration
...
3. Choose your preferred TopRouter model
...
- Check network latency to TopRouter
