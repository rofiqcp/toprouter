...
Integrate TopRouter with Claude Code CLI to route your Anthropic API requests through TopRouter's intelligent routing system.
...
Claude Code supports the following model aliases that map to TopRouter models:
