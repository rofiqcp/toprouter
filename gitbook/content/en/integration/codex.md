...
Integrate TopRouter with OpenAI Codex CLI to route your OpenAI API requests through TopRouter's intelligent routing system.
...
TopRouter provides the following Codex models:
...
1. Verify your API key is correct in TopRouter dashboard
...
1. Verify the model name matches your TopRouter configuration
2. Check that the OpenAI provider connection is active in TopRouter dashboard
...
Make sure you have configured your API key in the TopRouter cloud dashboard.
