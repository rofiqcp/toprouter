...
Common issues and solutions when using TopRouter.
...
1. **Auto-refresh (default):**
   TopRouter automatically refreshes tokens. Wait 30 seconds and retry.
...
1. **Check if TopRouter is running:**
   ```bash
   # Check process
