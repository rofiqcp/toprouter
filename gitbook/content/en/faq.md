...
Common questions about TopRouter.

---

## What is TopRouter?

**TopRouter is an AI model router that maximizes your subscription value and minimizes costs.**
...
**TopRouter uses a 3-tier pricing strategy:**
...
**Yes, TopRouter itself is 100% free and open source.**
...
**Yes! This is TopRouter's core feature.**
...
**TopRouter tracks quota in real-time for all providers:**
...
## Can I self-host TopRouter?

**Yes! TopRouter supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.toprouter`)
...
**Yes, TopRouter prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.toprouter` (or custom `DATA_DIR`)
- No data sent to TopRouter servers
...
**What TopRouter stores:**
- Provider OAuth tokens (encrypted)
- API keys (encrypted)
- Usage statistics (local only)
- Combo configurations

**What TopRouter does NOT store:**
...
**Breaking changes:**
- Check [CHANGELOG.md](https://github.com/decolua/toprouter/blob/main/CHANGELOG.md)
- Backup `~/.toprouter` before major updates
...
See [CONTRIBUTING.md](https://github.com/decolua/toprouter/blob/main/CONTRIBUTING.md) for details.
