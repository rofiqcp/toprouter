...
Hướng dẫn cài đặt chi tiết cho TopRouter với mẹo troubleshooting.
...
Cài TopRouter toàn cục để dùng ở bất kỳ đâu:
...
**Lợi ích:**
- ✅ Chạy từ mọi thư mục
- ✅ Lệnh đơn giản: `toprouter`
- ✅ Auto-update với `npm update -g toprouter`
...
3. Data directory được tạo tại `~/.toprouter`
...
**Vấn đề:** TopRouter dùng quá nhiều RAM
