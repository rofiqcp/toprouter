...
Tích hợp TopRouter với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- TopRouter API key từ [dashboard](https://toprouter.com/dashboard)
- TopRouter đang chạy (cục bộ hoặc cloud)
...
### 2. Thêm Cấu hình Model TopRouter
...
3. Chọn model TopRouter ưa thích
...
- Kiểm tra TopRouter đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến TopRouter
