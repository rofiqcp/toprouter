...
Tích hợp TopRouter với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model TopRouter có sẵn:
...
### Connection Failed
- Xác minh TopRouter đang chạy: `curl http://localhost:20128/health`
