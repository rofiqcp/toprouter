...
Những câu hỏi phổ biến về TopRouter.

---

## TopRouter là gì?

**TopRouter là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**TopRouter dùng chiến lược pricing 3 tầng:**
...
## TopRouter có miễn phí không?

**Có, TopRouter hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của TopRouter.**
...
**TopRouter theo dõi quota thời gian thực cho tất cả provider:**
...
## Tôi có thể self-host TopRouter không?

**Có! TopRouter hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.toprouter`)
...
**Có, TopRouter ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**
- Mọi dữ liệu lưu cục bộ tại `~/.toprouter` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server TopRouter
...
## Làm thế nào để cập nhật TopRouter?
...
**Breaking changes:**
- Xem [CHANGELOG.md](https://github.com/decolua/toprouter/blob/main/CHANGELOG.md)
- Backup `~/.toprouter` trước khi update lớn
...
Xem [CONTRIBUTING.md](https://github.com/decolua/toprouter/blob/main/CONTRIBUTING.md) để biết chi tiết.

---

## Cần trợ giúp thêm?

- **Documentation:** [toprouter.com/docs](https://toprouter.com/docs)
