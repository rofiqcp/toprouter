...
Triển khai TopRouter trên VPS hoặc Docker để truy cập từ xa và dùng trong production.
...
| `DATA_DIR` | `~/.toprouter` | Đường dẫn lưu database và data |
...
Tạo `/etc/nginx/sites-available/toprouter`:
...
# If NOT using reverse proxy, allow TopRouter ports
