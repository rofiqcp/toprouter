...
Các vấn đề và giải pháp phổ biến khi dùng TopRouter.
...
1. **Auto-refresh (mặc định):**
   TopRouter tự refresh tokens. Đợi 30 giây rồi thử lại.
...
**Nguyên nhân:**
- TopRouter không chạy
- Port 20128 bị chặn
- Firewall chặn kết nối

**Giải pháp:**

1. **Khởi động TopRouter:**
   ```bash
   toprouter
   ```
...
1. **Kiểm tra TopRouter có chạy không:**
   ```bash
   # Check process
