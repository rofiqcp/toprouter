...
Problemas comunes y soluciones al usar TopRouter.
...
1. **Refresh automático (por defecto):**
   TopRouter refresca automáticamente los tokens. Espera 30 segundos y reintenta.
...
**Causas:**
- TopRouter no está ejecutándose
...
4. **Usa el endpoint en la nube:**
   ...
   ```
   Endpoint: https://toprouter.com/v1
   ```
...
1. **Verifica si TopRouter está ejecutándose:**
   ```bash
   # Verifica el proceso
   ps aux | grep toprouter
...
- **GitHub Issues:** [github.com/decolua/toprouter/issues](https://github.com/decolua/toprouter/issues)
