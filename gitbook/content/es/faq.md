...
Preguntas comunes sobre TopRouter.

---

## ¿Qué es TopRouter?

**TopRouter es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**TopRouter usa una estrategia de precios de 3 niveles:**
...
**Sí, TopRouter en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de TopRouter.**
...
**TopRouter rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿TopRouter funciona con Cursor?

**Sí, pero Cursor requiere un endpoint en la nube.**

**Problema:** Cursor IDE no soporta endpoints en localhost.

**Solución:** Usa el despliegue en la nube de TopRouter:

```
Cursor Settings → Models → Advanced:
  OpenAI API Base URL: https://toprouter.com/v1
...
## ¿Puedo auto-hospedar TopRouter?

**¡Sí! TopRouter soporta múltiples opciones de despliegue:**
...
- `DATA_DIR` - Ruta de almacenamiento de la base de datos (por defecto: `~/.toprouter`)
...
**Sí, TopRouter prioriza la seguridad y privacidad:**

**Almacenamiento local:**
- Todos los datos se almacenan localmente en `~/.toprouter` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de TopRouter
...
### Docker
```bash
docker pull toprouter:latest
docker stop toprouter
docker rm toprouter
docker run -d \
  -p 3000:3000 \
  -v toprouter-data:/app/data \
...
**Cambios disruptivos:**
- Revisa [CHANGELOG.md](https://github.com/decolua/toprouter/blob/main/CHANGELOG.md)
- Respalda `~/.toprouter` antes de actualizaciones mayores
...
1. **Reportar bugs:**
   - [GitHub Issues](https://github.com/decolua/toprouter/issues)
   - Incluye logs de error, pasos para reproducir

2. **Solicitar características:**
   - [GitHub Discussions](https://github.com/decolua/toprouter/discussions)
   - Describe el caso de uso y los beneficios

3. **Enviar código:**
   ```bash
   # Fork del repo
   git clone https://github.com/YOUR_USERNAME/toprouter.git
   cd toprouter
...
Consulta [CONTRIBUTING.md](https://github.com/decolua/toprouter/blob/main/CONTRIBUTING.md) para detalles.

---

## ¿Necesitas más ayuda?

- **Documentación:** [toprouter.com/docs](https://toprouter.com/docs)
