...
Guía detallada de instalación de TopRouter con consejos de solución de problemas.
...
Instala TopRouter globalmente para usar desde cualquier lugar:
...
- ✅ Comando simple: `toprouter`
- ✅ Auto-actualizaciones con `npm update -g toprouter`
...
3. Se crea el directorio de datos en `~/.toprouter`
...
**Ubicación por defecto:** `~/.toprouter`
...
**Problema:** TopRouter usa demasiada RAM
...
nano ~/.bashrc  # o ~/.zshrc
# Eliminar exports relacionados con toprouter
```
...
- **Sitio web**: [toprouter.com](https://toprouter.com)
