...
Pon en marcha TopRouter en 5 minutos y comienza a enrutar solicitudes de IA de forma inteligente.
...
Apunta tu herramienta de codificación a TopRouter:
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [desde el dashboard de toprouter]
