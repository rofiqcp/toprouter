...
Integra TopRouter con Claude Code CLI para enrutar tus solicitudes de la API de Anthropic a través del sistema de enrutamiento inteligente de TopRouter.
...
Claude Code soporta los siguientes aliases de modelos que mapean a modelos de TopRouter:
...
```bash
export ANTHROPIC_BASE_URL="https://toprouter.com"
```
