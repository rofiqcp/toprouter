...
TopRouter es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

TopRouter proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a TopRouter usando estas configuraciones:

**TopRouter local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de TopRouter (cc/*, cx/*, glm/*, etc.)
```

**TopRouter en la nube:**
```
Base URL: https://toprouter.com/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de TopRouter (cc/*, cx/*, glm/*, etc.)
```
...
**Problema:** No se puede conectar a TopRouter
```bash
# Verifica si TopRouter está corriendo
...
**Solución:**
- Verifica que TopRouter esté corriendo
...
- Verifica la conexión de red a TopRouter
