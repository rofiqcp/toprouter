...
TopRouterをClaude Code CLIと統合し、AnthropicのAPIリクエストをTopRouterのインテリジェントルーティングシステム経由でルーティングします。
...
Claude CodeはTopRouterモデルにマッピングされる以下のモデルエイリアスをサポート:
