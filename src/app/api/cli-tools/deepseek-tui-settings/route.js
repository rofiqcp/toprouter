...
// Build TOML config for TopRouter (openai provider mode)
const buildTopRouterConfig = (baseUrl, apiKey, model) => {
...
// Detect TopRouter by checking if provider is "openai" and base_url points to localhost/127.0.0.1
