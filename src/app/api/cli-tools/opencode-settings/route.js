...
// POST - Apply TopRouter as openai-compatible provider (multi-model support)
...
// DELETE - Remove TopRouter provider or specific models from config
export async function DELETE(request) {
  try {
    ...
    return NextResponse.json({
      success: true,
      message: modelToRemove ? `Model "${modelToRemove}" removed` : "TopRouter settings removed from OpenCode",
    });
  } catch (error) {
