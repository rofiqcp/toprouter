  ...
  return (
    <div className="flex min-w-0 flex-col gap-6 px-1 sm:px-0">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Button icon="add" onClick={() => { setCreateKey(k => k + 1); setShowCreateModal(true); }} className="w-full sm:w-auto whitespace-nowrap">
          Create Combo
        </Button>
      </div>
      ...
      {combos.length === 0 ? (
        <Card>
          <div className="text-center py-12">
            ...
            <Button icon="add" onClick={() => { setCreateKey(k => k + 1); setShowCreateModal(true); }} className="w-full sm:w-auto">
              Create Combo
            </Button>
          </div>
        </Card>
...
function ComboFormModal({ isOpen, combo, onClose, onSave, activeProviders, kindFilter = null, modelAliases = {} }) {
