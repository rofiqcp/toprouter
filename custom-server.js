...
function startBackgroundTokenRefreshFromCustomServer() {
  // In a Next standalone build, initializeApp already owns this scheduler.
  // Avoid importing raw source ESM from the CommonJS wrapper a second time,
  // which otherwise triggers Node MODULE_TYPELESS_PACKAGE_JSON warnings.
  if (fs.existsSync(path.join(__dirname, "server.js"))) return;
