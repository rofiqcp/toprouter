 ...
 * into toprouter-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are toprouter fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic toprouter variant set for a single upstream Kiro model.
 *
 ...
 * into toprouter variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
