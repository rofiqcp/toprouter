export default {
  ...
  display: {
    ...
    notice: { apiKeyUrl: "https://modelstudio.console.alibabacloud.com" },
  },
  category: "apikey",
  authType: "apikey",
  transport: null,
  ...
  imageConfig: {
    baseUrl: "https://ws-hl022otpkn5qioav.ap-southeast-1.maas.aliyuncs.com/api/v1/images/generations",
  },
  imageEditConfig: {
    baseUrl: "https://ws-hl022otpkn5qioav.ap-southeast-1.maas.aliyuncs.com/api/v1/images/edits",
  },
  videoConfig: {
    baseUrl: "https://ws-hl022otpkn5qioav.ap-southeast-1.maas.aliyuncs.com/api/v1/video/generations",
  },
  models: [
    ...
    { id: "qwen-image-2.0", name: "Qwen Image 2.0", kind: "image", params: ["size", "n"] },
    ...
    { id: "z-image-turbo", name: "Z Image Turbo", kind: "image", params: ["size", "n"] },
